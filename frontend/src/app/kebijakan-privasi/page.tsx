        ...
        <div className="flex gap-10 items-start">
          ...
          <article className="flex-1 min-w-0 space-y-10">
            ...
            <div className="bg-primary-container border border-[#BFDBFE] rounded-xl p-6">
              <p className="text-sm text-primary font-semibold leading-relaxed">Dengan menggunakan Pelataran UMKM, Anda menyetujui pengumpulan dan penggunaan data sesuai kebijakan ini. Pertanyaan? Hubungi <a href={CONTACT_EMAIL_MAILTO} className="font-bold underline">{CONTACT_EMAIL}</a> atau Chat Admin.</p>
            </div>
          </article>
        </div>
      </main>
