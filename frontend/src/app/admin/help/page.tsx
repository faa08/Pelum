      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
        ...
        <section className="lg:col-span-2 bg-white border border-surface-container p-6 rounded-xl shadow-sm space-y-4">
          ...
          <form onSubmit={handleSendTicket} className="space-y-4">
            ...
            <div className="space-y-2">
              <label className="block text-xs font-bold uppercase tracking-wider text-secondary">Deskripsi Masalah</label>
              <textarea 
                rows={4}
                required
        ...
        <section className="bg-white border border-surface-container p-6 rounded-xl shadow-sm space-y-4 flex flex-col justify-between">
          <div className="space-y-3">
            ...
            <p className="text-xs text-secondary leading-relaxed font-medium">Hubungi hotline developer jika terjadi kendala sistem kritis/down.</p>
            <div className="space-y-2 pt-2">
              ...
              <div className="flex items-center gap-3 text-xs">
                ...
                <span className="font-semibold text-secondary font-medium">Senin - Jumat, 09:00 - 17:00 WIB</span>
              </div>
            </div>
          </div>
